...
public class Route {
    ...
    public int getOriginNone() {
        return originNone;
    }

    public int getDestinationNone() {
    ...
    public String toString() {
        return "Route[source=" + originNone + ", destination=" + destinationNone +   ", path = " + path + ", kFindIndex=" + kFindIndex + ", allConflictRoutes=" + (allConflictRoutes.size()) + "]\n";
    }
    ...
    public short[] getSlotOcupationLink() {
        return this.slotOcupationLink;
    }
    ...
    public int getOcupation() {
        return this.numberOfSlotOcupation;
    }
